...
class Social_Circles_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays select social icons.', 'scw' ),
		);
		...
		$this->WP_Widget( 'social-circles', __( 'Social Circles', 'scw' ), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<p><label><input id="<?php echo $this->get_field_id( 'new_window' ); ?>" type="checkbox" name="<?php echo $this->get_field_name( 'new_window' ); ?>" value="1" <?php checked( 1, $instance['new_window'] ); ?>/> <?php esc_html_e( 'Open links in new window?', 'scw' ); ?></label></p>

		<p>
			<label for="<?php echo $this->get_field_id( 'style' ); ?>"><?php _e( 'Icon Font', 'scw' ); ?>:</label>
		...
		<p><label for="<?php echo $this->get_field_id( 'bg_color' ); ?>"><?php _e( 'Icon Color:', 'scw' ); ?></label> <input id="<?php echo $this->get_field_id( 'bg_color' ); ?>" name="<?php echo $this->get_field_name( 'bg_color' ); ?>" type="text" value="<?php echo esc_attr( $instance['bg_color'] ); ?>" size="8" /></p>

		<p><label for="<?php echo $this->get_field_id( 'bg_color_hover' ); ?>"><?php _e( 'Hover Color:', 'scw' ); ?></label> <input id="<?php echo $this->get_field_id( 'bg_color_hover' ); ?>" name="<?php echo $this->get_field_name( 'bg_color_hover' ); ?>" type="text" value="<?php echo esc_attr( $instance['bg_color_hover'] ); ?>" size="8" /></p>

		<p>
			<label for="<?php echo $this->get_field_id( 'alignment' ); ?>"><?php _e( 'Alignment', 'scw' ); ?>:</label>
			<select id="<?php echo $this->get_field_id( 'alignment' ); ?>" name="<?php echo $this->get_field_name( 'alignment' ); ?>">
				<option value="alignleft" <?php selected( 'alignleft', $instance['alignment'] ) ?>><?php _e( 'Align Left', 'scw' ); ?></option>
				<option value="alignright" <?php selected( 'alignright', $instance['alignment'] ) ?>><?php _e( 'Align Right', 'scw' ); ?></option>
			</select>
		</p>
